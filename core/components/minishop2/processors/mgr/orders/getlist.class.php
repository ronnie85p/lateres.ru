...
class msOrderGetListProcessor extends GetListProcessor
{
    ...
    {
        $this->ms2 = $this->modx->services->get('minishop2');
    ...
    public function prepareQueryAfterCount(xPDO\Om\xPDOQuery $c)
    {
        ...
        $c->query['where'] = [[
            new xPDO\Om\xPDOQueryCondition(['sql' => 'msOrder.id IN ' . $ids, 'conjunction' => 'AND']),
        ]];
    ...
    public function outputArray(array $array, $count = false)
    {
        ...
        $month->where(['status:IN' => [2, 3], 'type' => 0]);
