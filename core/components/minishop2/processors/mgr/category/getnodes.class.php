...
class msCategoryGetNodesProcessor extends GetNodes
{
    ...
    * @return array
    */
    public function prepareContextNode(MODX\Revolution\modContext $context)
    {
        $context->prepare();
    ...
    * @return array
    */
    public function prepareResourceNode(MODX\Revolution\modResource $resource)
    {
