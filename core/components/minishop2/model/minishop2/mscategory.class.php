...
class msCategory extends MODX\Revolution\modResource
{
    ...
    */
    public static function load(xPDO\xPDO &$xpdo, $className, $criteria = null, $cacheFlag = true)
    {
        ...
        $loaded =  parent::load($xpdo, $className, $criteria, $cacheFlag);

        // $xpdo->log(xPDO\xPDO::LOG_LEVEL_ERROR, 'LOAD CLASS '. $className . print_r($loaded, true));
        return $loaded;
    }
    ...
    * @return array
    */
    public static function loadCollection(xPDO\xPDO &$xpdo, $className, $criteria = null, $cacheFlag = true)
    {
        if (!is_object($criteria)) {
            $criteria = $xpdo->getCriteria($className, $criteria, $cacheFlag);
        }
    ...
    * @return string
    */
    public static function getControllerPath(xPDO\xPDO &$modx)
    {
    ...
    */
    public function getNeighborhood()
    {
        ...
        $c = $this->xpdo->newQuery('modResource', ['parent' => $this->parent, 'class_key' => 'msCategory']);
