...
class msProductData extends xPDOSimpleObject
{
    ...
    * @return array
    */
    public static function loadOptions(xPDO\xPDO $xpdo, $product)
    {
    ...
    */
    public function updateProductImage()
    {
        ...
        if (empty($arr['thumb']) && $miniShop2 = $this->xpdo->services->add('minishop2')) {
    ...
    */
    public function getPrice($data = [])
    {
        ...
        /** @var miniShop2 $miniShop2 */
        if ($miniShop2 = $this->xpdo->services->get('minishop2')) {
            if (empty($data)) {
                $data = $this->toArray();
            }
            $params = [
    ...
    * */
    public function modifyFields($data = [])
    {
        ...
        /** @var miniShop2 $miniShop2 */
        $miniShop2 = $this->xpdo->services->get('minishop2');
        $params = [
            'product' => $this,
            'data' => $data,
        ];
