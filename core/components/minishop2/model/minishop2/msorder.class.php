 ...
 * @property int id
 */
class msOrder extends xPDO\Om\xPDOSimpleObject
{
    /**
    * @return bool
    */
    ...
    public function save($cacheFlag = null)
    {
        ...
        if ($this->xpdo instanceof MODX\Revolution\modX) {
            $this->xpdo->invokeEvent('msOnBeforeSaveOrder', [
                'mode' => $isNew ? MODX\Revolution\modSystemEvent::MODE_NEW : MODX\Revolution\modSystemEvent::MODE_UPD,
                'object' => $this,
                'msOrder' => $this,
                'cacheFlag' => $cacheFlag,
            ]);
        ...
        if ($saved && $this->xpdo instanceof MODX\Revolution\modX) {
