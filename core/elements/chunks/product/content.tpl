...
<div class="product" id="product-[[*id]]">
    ...
    <div class="row">
        <div class="col-7">
            <h1 class="h3" style="font-weight: 500">[[*longtitle]]</h1>
        </div>
    </div>

    <div class="row mb-4">
        <div class="col-6">
            <span class="px-2 py-1">{$rating.rate}</span>
            <a href="#reviews" class="scroll-to">{$reviews.count} отзывов</a>
            <a href="#questions" class="scroll-to">{$questions.count} вопросов </a>
            <a href="#orders" class="scroll-to">{$orders.count} заказов</a>
        </div>
        <div class="col-6 text-end">
            <span class="">Просмотры: {$views.count} (сегодня: +{$views.day})</span>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-7">
            ...
            <div class="gallery_ slick-carousel" data-slick='{ 
                "dots": true,
                "draggable": false,
                "infinite": false,
                "speed": 300,
                ...
                {foreach $images as $image}
                    <a href="{$image}" data-lg-size_="1600-2400">
                        <img class="rounded w-100" src="{$image}" style="width: 100%"  />
                    </a>
                {/foreach}
            </div>
        ...
        <div class="col-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="">
                        <button class="btn btn-success" type="button"><i class="icon-shopping-cart"></i> В корзину</button>
                        <button class="btn btn-outline-secondary" type="button"><i class="icon-shopping-"></i> Купить сейчас</button>
                        <button class="btn" type="button"><i class="icon-heart" style="font-size: 1.3em"></i></button>
                    </div>
    ...
    <div class="mt-2x mb-4 bg-light p-2 sticky-top" id="product-nav">
