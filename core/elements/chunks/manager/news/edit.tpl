{set $categories = '!pdoMenu' | snippet : [
    'parents' => '5',
    'level' => 1,
    'tpl' => '@INLINE <option value="{$id}"{$id == "'~ $resource.parent ~'" ? "selected" : ""}>{$menutitle}</option>',
...
{set $subjects = '!pdoMenu' | snippet : [
    'parents' => '342',
    'level' => 1,
    'tpl' => '@INLINE <option value="{$id}"{$id == "'~ $resource.subject ~'" ? "selected" : ""}>{$menutitle}</option>',
    'tplOuter' => '@INLINE {$wrapper}'
]}
...
{set $productCategories = '!pdoMenu' | snippet : [
    ...
    'level' => 2,
    'displayStart' => 0,
    'tpl' => '@INLINE <option value="{$id}"{$id == "'~ $resource.products_category ~'" ? "selected" : ""}>{$menutitle}</option>{$wrapper}',
