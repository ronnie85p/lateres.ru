...
<form class="wf-ress-form validate no-submit">
    ...
    <input type="hidden" name="action" value="adv/create">
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                <input class="utube-video form-control" name="utube_video" value="" placeholder="Например: https://www.youtube.com/watch?v=qPeVoi6OmRc">
            </div>
        </div>
    </div>
