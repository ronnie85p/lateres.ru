...
if (!empty($_GET['msorder'])) {
    ...
    return $miniShop2->pdoTools->getChunk($tpl);
}
...
$output = $miniShop2->pdoTools->getChunk($tpl, [
    'total' => $total,
    'products' => $products,
...
if ($modx->user->hasSessionContext('mgr') && !empty($showLog)) {
    $output .= '<pre class="msCartLog">' . print_r($miniShop2->pdoTools->getTime(), true) . '</pre>';
}
